...
def searching_system(wanted_items,database_name):
    ...
    while types_of_needed_items >= item_on:
        ...
        current_item = 'C:/Component-Caulator/premade_databases/'+database_name+'/Entry-'+current_item+'.txt'
...
def database_settings_system(database_name):
    settings_file_location = 'C:/Component-Caulator/premade_databases/'+database_name+'/database_settings_file.txt'
