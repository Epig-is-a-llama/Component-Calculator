...
print('\n.EXE installer for the database created with the name set as: `'+database_name+'-database-installer` when run this will automaticly install the database onto the computer if they have the base program already installed if it does not it will direct them to do so to use this database.\n')
