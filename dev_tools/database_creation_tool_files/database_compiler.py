...
un_complied_database_name = input('Please inlue the name of the .txt file which contains')
...
exe_config_list[26] = 'TargetName=C:/Component-Calculator/dev_tools/'+database_name+'.EXE'
original = r'C:/Component-Calculator/dev_tools/compiled_databases/'+database_name+'.zip'
target = r'C:/Component-Calculator/dev_tools/compiled_databases/database.zip'
# creates a copy of the .zip file with the name 'database' this file is delated once it has been used to create the .exe installer for the database
shutil.copyfile(original, target)
# runs the command which starts the batchfile which contains the code to create the .exe file
subprocess.call([r'C:/Component-Calculator/dev_tools/databse_packer.bat'])
...
input('Now that the database has been fully processed you may now press enter to exit: ')
